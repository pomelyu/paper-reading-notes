...
channels2 ), a conventional CNN backbone generates a lower-resolution activation
                                                                        0 W0
map f ∈ RC×H×W . Typical values we use are C = 2048 and H, W = H       32 , 32 .
...
                                                                 End-to-End Object Detection with Transformers                                                                                                                                                                                  15
                            ...
                            Encoded image                                                                 Resnet features
                             (d x H/32 x W/32)                                   Res5                                           Res4                                 Res3                                 Res2
                                      ...
                                      Multi head attention                                         2 x (Conv 3x3 + GN + ReLU)                                                                                           Conv 3x3 + GN + ReLU + Conv 3x3
                                                                                                                                              Conv 3x3 + GN + ReLU                 Conv 3x3 + GN + ReLU                                                                     Pixel-wise argmax
                                                                                     Concatenate                                2x up + add                          2x up + add                          2x up + add
