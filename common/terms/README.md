...
| CoT | Chain-of-Thought | Prompting/generation scheme where a model produces intermediate reasoning steps before its final answer, improving performance on multi-step tasks. |
